...
?>
  <div class="container-fluid mr-bot40 mg-posts-sec-inner">
        ...
        <div class="row">
            <?php $you_missed_title = get_theme_mod('you_missed_title', esc_html__('You missed','news-int'));
            if($you_missed_title) { ?>
            <div class="col-md-12">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6 text-xs">
                                <p>
                                <a href="<?php echo esc_url( __( 'https://wordpress.org/', 'news-int' ) ); ?>">
								<?php
								/* translators: placeholder replaced with string */
								printf( esc_html__( 'Proudly powered by %s', 'news-int' ), 'WordPress' );
								?>
								</a>
								<span class="sep"> | </span>
								<?php
								/* translators: placeholder replaced with string */
								printf( esc_html__( 'Theme: %1$s by %2$s.', 'news-hunt' ), 'News Int', '<a href="' . esc_url( __( 'https://themeansar.com/', 'news-hunt' ) ) . '" rel="designer">Themeansar</a>' );
								?>
								</p>
                            </div>
